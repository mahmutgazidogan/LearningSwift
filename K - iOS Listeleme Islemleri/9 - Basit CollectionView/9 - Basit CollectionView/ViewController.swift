...
class ViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        // CollectionView hücreleri arasındaki boşlukları ayarlıyoruz
...
extension ViewController:UICollectionViewDelegate,UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        cell.layer.borderColor = UIColor.blue.cgColor   // Kutucukların kenarındaki çizgilerin rengini verdik
        cell.layer.borderWidth = 0.5        // Renk verdiğimiz çizgilerin kalınlığını belirledik
        return cell
    }
