...
class FilmViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        if let k = kategori {
            ...
            filmlerByKategoriID(kategori_ad: k.kategori_ad!)
            
        }
        
    }
    
    func filmlerByKategoriID(kategori_ad:String){   // veritabanında kategori_id belli olmadığı için kategori_ad ile sorgu yapıp filmleri alıyoruz
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let url = URL(string: "http://kasimadalan.pe.hu/filmler/resimler/\(film.film_resim!).png") {
            ...
            DispatchQueue.global().async {      // verileri almak için
                ...
                DispatchQueue.main.async {      // verileri görüntülemek için
