...
class ViewController: UIViewController {
    ...
    override func viewWillAppear(_ animated: Bool) {    // Ana ekrana dönüldüğünde güncel arayüzü görmek için bu metodu kullandık
        tumNotlarAl()
    }
        ...
        URLSession.shared.dataTask(with: url){ data,response,error in
            ...
            do{
                ...
                DispatchQueue.main.async {
                    ...
                    self.notTableView.reloadData()  // Arayüz güncelledik
